...
//         <div className="foods_i">
//           <button className="pizza" onClick={() => setCategory("burger")}>
//             <img src={I2} alt="Burger" />
//             Burger
//           </button>
//           <button className="pizza" onClick={() => setCategory("pizza")}>
//             <img src={I3} alt="Pizza" />
//             Pizza
//           </button>
//           <button className="pizza" onClick={() => setCategory("sandwich")}>
//             <img src={I4} alt="Sandwich" />
//             Sandwich
//           </button>
//           <button className="pizza" onClick={() => setCategory("asian")}>
//             <img src={I5} alt="Asian food" />
//             Asian food
//           </button>
//           <button className="pizza" onClick={() => setCategory("menu")}>
//             <img src={I6} alt="All Menu" />
//             All Menu
//           </button>
//         </div>
...
//           <div className="st_t">
//             <span>
//               <img src={I15} alt="Timer" />
//               <p>Fastest Delivery in 30 Minutes</p>
//             </span>
//             <span className="del">
//               <img src={I16} alt="Delivery" />
//               <p>300+ delivery men</p>
//             </span>
//             <span>
//               <img src={I17} alt="Restaurants" />
//               <p>500+ restaurant & cafe shop</p>
//             </span>
//           </div>
//           <button>See More</button>
...
//             data2.map((d, i) => (
//               <div className="rest01" key={i}>
//                 <img src={d.image} alt="Restaurant" />
//                 <p className="b">{d.resName}</p>
//                 <span>
//                   <i className="fa-regular fa-clock"></i>
//                   <p>{d.description}</p>
...
//           </p>
//           <div className="image">
//             <img src={I21} alt="App Store" />
//             <img src={I22} alt="Google Play" />
//           </div>
//         </div>
//         <div className="app02">
//           <img src={I23} alt="Mobile App" />
//         </div>
//       </div>
...
//       <div className="what" data-aos="zoom-in">
//         <div className="what1">
//           <img src={I24} alt="Client" />
//         </div>
//         <div className="what2">
//           <p>
//             <img src={I25} alt="quote" /> EFood has the most intriguing food
//             order system in the country. UI in both their app and web is very
//             simple and easy to use, enhancing the UX. Their delivery men are
//             also quite professional and know the neighborhood well. Till now I
//             never had to guide them to my address for delivery.
//             <img src={I26} alt="quote" />
//           </p>
//           <div className="what02">
//             <span>
//               <p>Angelina Jolie</p>
...
//         <h1>Subscribe to get the Latest Offer</h1>
//         <p>
//           Get our daily updates by subscribing to our newsletter. Please drop
//           your email below.
//         </p>
//       </div>
